...
if (isset($_POST["u_btn"])){
    ...
    if(empty($u_name) || empty($u_email) || empty($u_pass)){
        ...
        $insert = mysqli_query($conn,"INSERT INTO `musicapp` (`u_name`, `u_email`,`u_pass`)VALUES('$u_name', '$u_email','$u_pass')"); 
        echo "<b>Signup Successful Now CLICK on click to login</b>";
    }
...
<form action="register.php" class="box" method="post">
	  ...
	  <a href="login.php" style="color:#48dbfb;">Click to login</a>
    </form>
</body>
</html>
